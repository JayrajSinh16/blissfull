...
class OverjoyedScreen extends StatefulWidget {
  static const routeName = '/mood-tracker-overjoyed-screen';
  const OverjoyedScreen({super.key});

  @override
  State<OverjoyedScreen> createState() => _OverjoyedScreenState();
}

class _OverjoyedScreenState extends State<OverjoyedScreen> {
