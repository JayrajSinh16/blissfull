...
class NeturalScreen extends StatefulWidget {
  static const routeName = '/mood-tracker-netural-screen';
  const NeturalScreen({super.key});

  @override
  State<NeturalScreen> createState() => _NeturalScreenState();
}

class _NeturalScreenState extends State<NeturalScreen> {
